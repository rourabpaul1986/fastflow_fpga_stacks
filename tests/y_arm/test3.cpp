...
int main(int argc, char * argv[])
{
	...
	p01->add_stage(new middle(n, input_l_vadd, input_l_vadd, output_l_vadd, mem_offset_vadd,2));
        p01->add_stage(new FNodeTask(devices[0], kernel_vadds[2], chain));
	...
	pipe.add_stage(new drain(input_l_vinc, output_l_vinc, 1));
	//pipe.cleanup_nodes();
	//*************************************************************************
