...
int main(int argc, char * argv[])
{
    ...
    if (req_fpga>num_devices)
       req_fpga=num_devices; 
        ...
        //vinc-vadd
        std::cout << "Executing 1 worker two pipeline stages vinc->vadd \n";
        ...
        //vinc-vinc
        /*std::cout << "Executing 1 worker two pipeline stages vinc->vinc \n";
        p.add_stage(new generator(n, m, input_l_vinc, output_l_vinc, mem_offset_vinc,0));
        p.add_stage(new FNodeTask(device, kernel_vincs[0], chain));
        ...
        //vadd-vadd
        /*std::cout << "Executing 1 worker two pipeline stages vadd->vadd \n";
        ...
        p.add_stage(new middle(n, input_l_vadd, input_l_vadd, output_l_vadd, mem_offset_vadd, 1));
        p.add_stage(new FNodeTask(device, kernel_vadds[1],chain));
        p.add_stage(new drain(input_l_vadd, output_l_vadd));*/
        //vadd-vinc
        /*std::cout << "Executing 1 worker two pipeline stages vadd->vinc \n";
        p.add_stage(new generator(n, m, input_l_vadd, output_l_vadd, mem_offset_vadd));
        p.add_stage(new FNodeTask(device, kernel_vadds[0], chain));
