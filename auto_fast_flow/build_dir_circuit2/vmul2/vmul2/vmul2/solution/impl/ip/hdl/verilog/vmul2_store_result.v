...
wire  signed [63:0] sext_ln73_fu_111_p1;
wire   [31:0] zext_ln73_fu_121_p1;
wire   [0:0] icmp_ln73_fu_87_p2;
...
vmul2_store_result_Pipeline_mem_wr grp_store_result_Pipeline_mem_wr_fu_73(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
assign empty_31_fu_103_p3 = ((icmp_ln73_fu_87_p2[0:0] == 1'b1) ? empty_fu_83_p1 : 31'd0);
...
assign icmp_ln73_fu_87_p2 = (($signed(size_dout) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign sext_ln73_fu_111_p1 = $signed(trunc_ln_reg_130);

assign zext_ln73_fu_121_p1 = empty_31_reg_136;

endmodule //vmul2_store_result
