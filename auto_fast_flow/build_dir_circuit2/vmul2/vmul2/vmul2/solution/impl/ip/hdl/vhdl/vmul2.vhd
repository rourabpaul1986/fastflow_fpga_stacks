...
architecture behav of vmul2 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "vmul2_vmul2,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu50-fsvh2104-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=4246,HLS_SYN_TPT=4173,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=3344,HLS_SYN_LUT=4405,HLS_VERSION=2023_1}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    component vmul2_load_input_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vmul2_compute_add IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vmul2_store_result IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vmul2_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component vmul2_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vmul2_start_for_store_result_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vmul2_start_for_compute_add_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vmul2_control_s_axi IS
    generic (
    ...
    component vmul2_gmem0_m_axi IS
    generic (
    ...
    component vmul2_gmem1_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_MAXREQS : INTEGER;
        MAX_READ_BURST_LENGTH : INTEGER;
...
begin
    control_s_axi_U : component vmul2_control_s_axi
    generic map (
    ...
    gmem0_m_axi_U : component vmul2_gmem0_m_axi
    generic map (
        CONSERVATIVE => 1,
        USER_MAXREQS => 69,
    ...
    gmem1_m_axi_U : component vmul2_gmem1_m_axi
    generic map (
        CONSERVATIVE => 1,
        USER_MAXREQS => 69,
        MAX_READ_BURST_LENGTH => 16,
    ...
    entry_proc_U0 : component vmul2_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_input_U0 : component vmul2_load_input
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_input_1_U0 : component vmul2_load_input_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    compute_add_U0 : component vmul2_compute_add
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    store_result_U0 : component vmul2_store_result
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    out_r_c_U : component vmul2_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    size_c11_U : component vmul2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    in1_stream_U : component vmul2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    in2_stream_U : component vmul2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    size_c_U : component vmul2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_stream_U : component vmul2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_store_result_U0_U : component vmul2_start_for_store_result_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_compute_add_U0_U : component vmul2_start_for_compute_add_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
