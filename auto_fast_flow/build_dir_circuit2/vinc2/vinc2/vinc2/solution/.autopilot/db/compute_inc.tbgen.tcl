...
set portList { 
	...
	{ in_stream_dout sc_in sc_lv 32 signal 2 } 
	{ in_stream_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ in_stream_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ in_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ in_stream_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "in_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_compute_inc_Pipeline_execute_fu_50", "Port" : "in_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_compute_inc_Pipeline_execute_fu_50", "Port" : "out_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_compute_inc_Pipeline_execute_fu_50", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_compute_inc_Pipeline_execute_fu_50.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	compute_inc {
		...
		in_stream {Type I LastRead 4 FirstWrite -1}
