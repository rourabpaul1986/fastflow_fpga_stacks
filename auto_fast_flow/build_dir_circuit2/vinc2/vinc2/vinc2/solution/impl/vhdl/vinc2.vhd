...
architecture behav of vinc2 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "vinc2_vinc2,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu50-fsvh2104-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=4244,HLS_SYN_TPT=4173,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=1842,HLS_SYN_LUT=3175,HLS_VERSION=2023_1}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal load_input_U0_size_c9_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_size_c9_write : STD_LOGIC;
    signal load_input_U0_in_stream_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_in_stream_write : STD_LOGIC;
    signal compute_inc_U0_ap_start : STD_LOGIC;
    signal compute_inc_U0_ap_done : STD_LOGIC;
    signal compute_inc_U0_ap_continue : STD_LOGIC;
    signal compute_inc_U0_ap_idle : STD_LOGIC;
    signal compute_inc_U0_ap_ready : STD_LOGIC;
    signal compute_inc_U0_size_read : STD_LOGIC;
    signal compute_inc_U0_size_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal compute_inc_U0_size_c_write : STD_LOGIC;
    signal compute_inc_U0_in_stream_read : STD_LOGIC;
    signal compute_inc_U0_out_stream_din : STD_LOGIC_VECTOR (31 downto 0);
    signal compute_inc_U0_out_stream_write : STD_LOGIC;
    ...
    signal size_c9_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal size_c9_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal size_c9_empty_n : STD_LOGIC;
    signal in_stream_full_n : STD_LOGIC;
    signal in_stream_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal in_stream_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal in_stream_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal start_for_compute_inc_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_compute_inc_U0_full_n : STD_LOGIC;
    signal start_for_compute_inc_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_compute_inc_U0_empty_n : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component vinc2_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component vinc2_compute_inc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vinc2_store_result IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vinc2_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component vinc2_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vinc2_start_for_store_result_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vinc2_start_for_compute_inc_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vinc2_control_s_axi IS
    generic (
    ...
    component vinc2_gmem0_m_axi IS
    generic (
...
begin
    control_s_axi_U : component vinc2_control_s_axi
    generic map (
    ...
    gmem0_m_axi_U : component vinc2_gmem0_m_axi
    generic map (
        CONSERVATIVE => 1,
        USER_MAXREQS => 69,
    ...
    entry_proc_U0 : component vinc2_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_input_U0 : component vinc2_load_input
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    compute_inc_U0 : component vinc2_compute_inc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    store_result_U0 : component vinc2_store_result
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    out_r_c_U : component vinc2_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    size_c9_U : component vinc2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    in_stream_U : component vinc2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    size_c_U : component vinc2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_stream_U : component vinc2_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_store_result_U0_U : component vinc2_start_for_store_result_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_compute_inc_U0_U : component vinc2_start_for_compute_inc_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= store_result_U0_ap_done;
    ap_idle <= (store_result_U0_ap_idle and load_input_U0_ap_idle and entry_proc_U0_ap_idle and compute_inc_U0_ap_idle);
    ...
    compute_inc_U0_ap_continue <= ap_const_logic_1;
    compute_inc_U0_ap_start <= start_for_compute_inc_U0_empty_n;
    ...
    start_for_compute_inc_U0_din <= (0=>ap_const_logic_1, others=>'-');
