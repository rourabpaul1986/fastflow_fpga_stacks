...
architecture behav of vinc2_store_result is 
...
attribute shreg_extract : string;
    ...
    signal empty_28_fu_103_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_28_reg_136 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal sext_ln67_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln67_fu_121_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln67_fu_87_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component vinc2_store_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_store_result_Pipeline_mem_wr_fu_73 : component vinc2_store_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (size_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                empty_28_reg_136 <= empty_28_fu_103_p3;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_store_result_Pipeline_mem_wr_fu_73_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    empty_28_fu_103_p3 <= 
        empty_fu_83_p1 when (icmp_ln67_fu_87_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    icmp_ln67_fu_87_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    m_axi_gmem0_AWADDR_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln67_fu_111_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWADDR <= sext_ln67_fu_111_p1;
    ...
    m_axi_gmem0_AWLEN_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln67_fu_121_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWLEN <= zext_ln67_fu_121_p1;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
        else 
    ...
    begin
        ...
        sext_ln67_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_130),64));
    ...
    zext_ln67_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_28_reg_136),32));
end behav;
