...
architecture behav of vadd2_store_result is 
...
attribute shreg_extract : string;
    ...
    signal sext_ln74_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln74_fu_121_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component vadd2_store_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_store_result_Pipeline_mem_wr_fu_73 : component vadd2_store_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    empty_31_fu_103_p3 <= 
        empty_fu_83_p1 when (icmp_ln74_fu_87_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    icmp_ln74_fu_87_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    m_axi_gmem0_AWADDR_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln74_fu_111_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axi_gmem0_AWLEN_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln74_fu_121_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        ...
        sext_ln74_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_130),64));
    ...
    zext_ln74_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_31_reg_136),32));
end behav;
