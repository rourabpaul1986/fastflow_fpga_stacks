...
architecture behav of vadd2_compute_add is 
...
attribute shreg_extract : string;
    ...
    component vadd2_compute_add_Pipeline_execute IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_compute_add_Pipeline_execute_fu_52 : component vadd2_compute_add_Pipeline_execute
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
