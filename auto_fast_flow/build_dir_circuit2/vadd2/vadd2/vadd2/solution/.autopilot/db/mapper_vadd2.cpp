...
using hls::sim::Byte;
extern "C" void vadd2(Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_vadd2_hw(volatile void * __xlx_apatb_param_in1, volatile void * __xlx_apatb_param_in2, volatile void * __xlx_apatb_param_out_r, int __xlx_apatb_param_size) {
...
__xlx_in2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_in2)[i]);
  ...
  // DUT call
  vadd2(__xlx_in1_out_r__tmp_vec.data(), __xlx_in2__tmp_vec.data(), __xlx_offset_byte_param_in1, __xlx_offset_byte_param_in2, __xlx_offset_byte_param_out_r, __xlx_apatb_param_size);
