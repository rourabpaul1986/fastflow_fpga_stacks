; ModuleID = '/home/rourab/Auto_FastFlow_fpga/auto_fast_flow/build_dir_circuit2/vadd2/vadd2/vadd2/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_vadd2_ir(i32* noalias nocapture nonnull readonly "maxi" %in1, i32* noalias nocapture nonnull readonly "maxi" %in2, i32* noalias nocapture nonnull "maxi" %out, i32 %size) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_vadd2_hw(i32* %in1_copy, i32* %in2_copy, i32* %out_copy, i32 %size)
...
declare void @apatb_vadd2_hw(i32*, i32*, i32*, i32)
...
define void @vadd2_hw_stub_wrapper(i32*, i32*, i32*, i32) #4 {
entry:
  call void @copy_out(i32* null, i32* %0, i32* null, i32* %1, i32* null, i32* %2)
  call void @vadd2_hw_stub(i32* %0, i32* %1, i32* %2, i32 %3)
  call void @copy_in(i32* null, i32* %0, i32* null, i32* %1, i32* null, i32* %2)
  ret void
}

declare void @vadd2_hw_stub(i32*, i32*, i32*, i32)
