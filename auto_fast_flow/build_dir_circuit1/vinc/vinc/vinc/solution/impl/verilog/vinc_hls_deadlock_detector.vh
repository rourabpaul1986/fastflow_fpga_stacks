...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    vinc_hls_deadlock_detect_unit #(4, 0, 2, 2) vinc_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vinc_hls_deadlock_detect_unit #(4, 1, 2, 2) vinc_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vinc_hls_deadlock_detect_unit #(4, 2, 2, 2) vinc_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vinc_hls_deadlock_detect_unit #(4, 3, 2, 2) vinc_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
...
`include "vinc_hls_deadlock_report_unit.vh"
