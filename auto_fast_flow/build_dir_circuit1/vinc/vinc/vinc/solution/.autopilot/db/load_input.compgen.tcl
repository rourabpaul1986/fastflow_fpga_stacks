...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_size_c9 \
    op interface \
    ports { size_c9_din { O 32 vector } size_c9_num_data_valid { I 2 vector } size_c9_fifo_cap { I 2 vector } size_c9_full_n { I 1 bit } size_c9_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_stream_din { O 32 vector } in_stream_num_data_valid { I 2 vector } in_stream_fifo_cap { I 2 vector } in_stream_full_n { I 1 bit } in_stream_write { O 1 bit } } \
} "
}
