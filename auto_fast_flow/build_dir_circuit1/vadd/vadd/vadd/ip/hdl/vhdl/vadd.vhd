...
architecture behav of vadd is 
    ...
    "vadd_vadd,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu50-fsvh2104-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=4244,HLS_SYN_TPT=4173,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=3013,HLS_SYN_LUT=4233,HLS_VERSION=2023_1}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    component vadd_load_input_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vadd_store_result IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vadd_start_for_store_result_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    load_input_U0 : component vadd_load_input
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    load_input_1_U0 : component vadd_load_input_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    store_result_U0 : component vadd_store_result
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    size_c11_U : component vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    in1_stream_U : component vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    in2_stream_U : component vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_stream_U : component vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_store_result_U0_U : component vadd_start_for_store_result_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
