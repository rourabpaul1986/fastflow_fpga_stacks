...
wire   [31:0] add_ln63_fu_100_p2;
reg   [31:0] add_ln63_reg_117;
reg   [30:0] i_fu_42;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln61_fu_83_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln61_fu_83_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln63_fu_100_p2 = (in2_stream_dout + in1_stream_dout);
...
assign icmp_ln61_fu_83_p2 = (($signed(i_cast_fu_79_p1) < $signed(size_load)) ? 1'b1 : 1'b0);

assign out_stream_din = add_ln63_reg_117;
