    ...
    function [240:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                ...
                1 : begin
                    proc_path = "vadd_vadd.load_input_U0";
                end
                2 : begin
                    proc_path = "vadd_vadd.load_input_1_U0";
                end
                3 : begin
                    proc_path = "vadd_vadd.compute_add_U0";
                end
                4 : begin
                    proc_path = "vadd_vadd.store_result_U0";
                end
                default : begin
                    proc_path = "unknown";
                end
                    ...
                    4: begin
                        if (~entry_proc_U0.out_r_c_blk_n) begin
                            if (~out_r_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.out_r_c_U' written by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.out_r_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~out_r_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.out_r_c_U' read by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.out_r_c_U");
                        ...
                        if (~start_for_store_result_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_store_result_U0_U.if_read) begin
                            $display("//      Blocked by full output start propagation FIFO 'vadd_vadd.start_for_store_result_U0_U' read by process 'vadd_vadd.store_result_U0',");
                        end
                    end
                    1: begin
                        if (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_load_input_U0_ap_ready) begin
                            $display("//      Blocked by input sync logic with process : 'vadd_vadd.load_input_U0'");
                        end
                    end
                    2: begin
                        if (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_load_input_1_U0_ap_ready) begin
                            $display("//      Blocked by input sync logic with process : 'vadd_vadd.load_input_1_U0'");
                        end
                    end
                    endcase
                end
                    ...
                    3: begin
                        if (~load_input_U0.size_c11_blk_n) begin
                            if (~size_c11_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.size_c11_U' written by process 'vadd_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c11_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.size_c11_U' read by process 'vadd_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                3 : begin
                    ...
                    1: begin
                        if (~compute_add_U0.size_blk_n) begin
                            if (~size_c11_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.size_c11_U' written by process 'vadd_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c11_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.size_c11_U' read by process 'vadd_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in1_stream_blk_n) begin
                            if (~in1_stream_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.in1_stream_U' written by process 'vadd_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.in1_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~in1_stream_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.in1_stream_U' read by process 'vadd_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.in1_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~start_for_compute_add_U0_U.if_empty_n & compute_add_U0.ap_idle & ~start_for_compute_add_U0_U.if_write) begin
                            $display("//      Blocked by missing 'ap_start' from start propagation FIFO 'vadd_vadd.start_for_compute_add_U0_U' written by process 'vadd_vadd.load_input_U0',");
                        end
                    end
                    4: begin
                        if (~compute_add_U0.size_c_blk_n) begin
                            if (~size_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.size_c_U' written by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.size_c_U' read by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.size_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.out_stream_blk_n) begin
                            if (~out_stream_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.out_stream_U' written by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.out_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~out_stream_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.out_stream_U' read by process 'vadd_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.out_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    2: begin
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in2_stream_blk_n) begin
                            if (~in2_stream_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'vadd_vadd.in2_stream_U' written by process 'vadd_vadd.load_input_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~in2_stream_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'vadd_vadd.in2_stream_U' read by process 'vadd_vadd.load_input_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path vadd_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                4 : begin
                    ...
                    0: begin
                        ...
                        if (~start_for_store_result_U0_U.if_empty_n & store_result_U0.ap_idle & ~start_for_store_result_U0_U.if_write) begin
                            $display("//      Blocked by missing 'ap_start' from start propagation FIFO 'vadd_vadd.start_for_store_result_U0_U' written by process 'vadd_vadd.entry_proc_U0',");
                        end
                    end
                    3: begin
