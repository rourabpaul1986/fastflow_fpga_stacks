...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    vmul_hls_deadlock_detect_unit #(5, 0, 3, 3) vmul_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vmul_hls_deadlock_detect_unit #(5, 1, 3, 3) vmul_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vmul_hls_deadlock_detect_unit #(5, 2, 3, 3) vmul_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vmul_hls_deadlock_detect_unit #(5, 3, 3, 3) vmul_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    vmul_hls_deadlock_detect_unit #(5, 4, 2, 2) vmul_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
...
`include "vmul_hls_deadlock_report_unit.vh"
